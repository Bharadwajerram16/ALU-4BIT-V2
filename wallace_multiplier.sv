...
assign p1[0][3]=a[0]&b[3];
assign p1[1][0]=a[1]&b[0];
assign p1[1][1]=a[1]&b[1];
assign p1[1][2]=a[1]&b[2];
assign p1[1][3]=a[1]&b[3];
assign p1[2][0]=a[2]&b[0];
assign p1[2][1]=a[2]&b[1];
assign p1[2][2]=a[2]&b[2];
assign p1[2][3]=a[2]&b[3];
assign p1[3][0]=a[3]&b[0];
assign p1[3][1]=a[3]&b[1];
assign p1[3][2]=a[3]&b[2];
assign p1[3][3]=a[3]&b[3];
